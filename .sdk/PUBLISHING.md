...
|---|---|---|
| `js/` | @voxgig-sdk/branch-daily-exports-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branch-daily-exports | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branch-daily-exports-js \
      --repository voxgig-sdk/branch-daily-exports-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branch-daily-exports-js` shows it, and
`npm trust revoke @voxgig-sdk/branch-daily-exports-js --id=<id>` removes it.
