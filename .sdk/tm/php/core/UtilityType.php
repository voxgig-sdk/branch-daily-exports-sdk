...
// BranchDailyExports SDK utility type

class BranchDailyExportsUtility
{
    ...
    public static function copy(BranchDailyExportsUtility $src): BranchDailyExportsUtility
    {
        $u = new BranchDailyExportsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
