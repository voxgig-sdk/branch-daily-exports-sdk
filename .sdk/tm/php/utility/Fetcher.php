...
// BranchDailyExports SDK utility: fetcher

class BranchDailyExportsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchDailyExportsSDK/1.0)';
    ...
    public static function call(BranchDailyExportsContext $ctx, string $fullurl, array $fetchdef): array
    {
