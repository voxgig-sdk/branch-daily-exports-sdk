...
// BranchDailyExports SDK utility: make_options

class BranchDailyExportsMakeOptions
{
    ...
    public static function call(BranchDailyExportsContext $ctx): array
    {
        ...
        //
        // `BranchDailyExportsSchema::optspec()` is built from the model:
        ...
        $optspec = BranchDailyExportsSchema::optspec();
