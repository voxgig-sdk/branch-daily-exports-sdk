...
// BranchDailyExports SDK paging feature
...
class BranchDailyExportsPagingFeature extends BranchDailyExportsBaseFeature
{
    ...
    private function _graphql_pre_request(BranchDailyExportsContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchDailyExportsContext $ctx): bool
    {
