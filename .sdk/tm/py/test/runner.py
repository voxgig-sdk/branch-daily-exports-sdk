...
class BranchDailyExportsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BranchDailyExportsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = BranchDailyExportsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = BranchDailyExportsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
