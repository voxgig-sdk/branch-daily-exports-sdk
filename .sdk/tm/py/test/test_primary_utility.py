...
from projectname_sdk import BranchDailyExportsSDK
from projectname_sdk.core.spec import BranchDailyExportsSpec
from projectname_sdk.core.result import BranchDailyExportsResult
from projectname_sdk.core.operation import BranchDailyExportsOperation
from projectname_sdk.core.error import BranchDailyExportsError
from projectname_sdk.feature.base_feature import BranchDailyExportsBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, BranchDailyExportsSDK.test(None, None))
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BranchDailyExportsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BranchDailyExportsSDK.test(None, None)
        utility = client._utility
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = BranchDailyExportsResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = BranchDailyExportsSDK.test(None, None)
        ...
        class TestInitFeature(BranchDailyExportsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BranchDailyExportsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = BranchDailyExportsSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = BranchDailyExportsSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchDailyExportsSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchDailyExportsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BranchDailyExportsSDK.test(None, setup.get('a') or {})
    ...
    def test_operator_basic(self):
        def subject(vin):
            if not isinstance(vin, dict):
                vin = {}
            op = BranchDailyExportsOperation(vin)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BranchDailyExportsSDK.test(None, setup.get('a') or {})
