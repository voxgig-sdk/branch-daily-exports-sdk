...
local function make_error_util(ctx, err)
  ...
  local msg = "BranchDailyExportsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BranchDailyExportsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BranchDailyExportsError then
