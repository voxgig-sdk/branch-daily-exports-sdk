...
type Args struct {
	Entity string         `json:"entity" jsonschema:"export"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BranchDailyExportsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-daily-exports_list",
		Description: "List records from BranchDailyExports. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-daily-exports_load",
		Description: "Load a single record from BranchDailyExports. " +
...
func runOp(client *sdk.BranchDailyExportsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchDailyExportsSDK, name string) (sdk.BranchDailyExportsEntity, error) {
