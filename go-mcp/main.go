// Command BranchDailyExports-mcp is an MCP server exposing the BranchDailyExports
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BranchDailyExports_list  — list records of an entity
//	BranchDailyExports_load  — load a single record of an entity
//
