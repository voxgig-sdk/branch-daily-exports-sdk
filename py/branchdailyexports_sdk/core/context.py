...
from branchdailyexports_sdk.core.control import BranchDailyExportsControl
...
from branchdailyexports_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchDailyExportsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BranchDailyExportsControl()
        ...
        if isinstance(sp, BranchDailyExportsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BranchDailyExportsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchDailyExportsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BranchDailyExportsOperation({})
        ...
        op = BranchDailyExportsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BranchDailyExportsError(code, msg, self)
