...
from branchdailyexports_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from branchdailyexports_sdk.utility import register

# Load features
from branchdailyexports_sdk.feature.base_feature import BranchDailyExportsBaseFeature
from branchdailyexports_sdk.features import _has_feature, _make_feature
...
class BranchDailyExportsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchDailyExportsUtility()
        self._utility = utility

        from branchdailyexports_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchDailyExportsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchDailyExportsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Export(self, data=None) -> "ExportEntity":
        ...
        from branchdailyexports_sdk.entity.export_entity import ExportEntity
        return ExportEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BranchDailyExportsSDK":
        if sdkopts is None:
            sdkopts = {}
