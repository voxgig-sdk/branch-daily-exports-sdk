# BranchDailyExports SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchDailyExportsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchDailyExportsSDK(...) and BranchDailyExportsSDK.test(...) become
#      BranchDailyExportsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchdailyexports_sdk"
_SDK_CLASS = "BranchDailyExportsSDK"
