...
type ExportEntity struct {
	name    string
	client  *core.BranchDailyExportsSDK
...
func NewExportEntity(client *core.BranchDailyExportsSDK, entopts map[string]any) *ExportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExportEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
