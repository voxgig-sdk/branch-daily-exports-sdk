...
// BranchDailyExports SDK utility: graphql
//
...
class BranchDailyExportsGraphql
{
    ...
    // equivalent.
    public static function body(BranchDailyExportsContext $ctx): mixed
    {
    ...
    public static function errors(BranchDailyExportsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
