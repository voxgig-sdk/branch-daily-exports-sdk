...
// BranchDailyExports SDK utility: result_basic

class BranchDailyExportsResultBasic
{
    public static function call(BranchDailyExportsContext $ctx): ?BranchDailyExportsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BranchDailyExportsError) ? $result->err->msg : (string)$result->err;
