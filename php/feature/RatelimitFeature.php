...
// BranchDailyExports SDK ratelimit feature
...
class BranchDailyExportsRatelimitFeature extends BranchDailyExportsBaseFeature
{
    ...
    private function _acquire(BranchDailyExportsContext $ctx): void
    {
    ...
    private function _track(BranchDailyExportsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
