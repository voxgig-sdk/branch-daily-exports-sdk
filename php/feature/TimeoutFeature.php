...
// BranchDailyExports SDK timeout feature
...
class BranchDailyExportsTimeoutFeature extends BranchDailyExportsBaseFeature
{
    ...
    private function _with_timeout(BranchDailyExportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchDailyExportsContext $_ctx, float $ms): void
    {
        $client = $this->client;
