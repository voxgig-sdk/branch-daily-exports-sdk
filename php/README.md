# BranchDailyExports PHP SDK



The PHP SDK for the BranchDailyExports API — an entity-oriented client using PHP conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `$client->Export()` — with named operations (`create`) instead of raw URL paths and query strings. Working with resources and verbs keeps call sites self-describing and reduces cognitive load.
...
- Releases: [https://github.com/voxgig-sdk/branch-daily-exports-sdk/releases](https://github.com/voxgig-sdk/branch-daily-exports-sdk/releases)
...
```php
// create() returns the ENTITY — call data_get() for the created Export record.
...
```php
require_once 'branchdailyexports_sdk.php';
$client = new BranchDailyExportsSDK($options);
```
...
```
php/
├── branchdailyexports_sdk.php          -- Main SDK class
...
The main class (`branchdailyexports_sdk.php`) exports the SDK class
