...
// BranchDailyExports SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchDailyExportsSDK::test)
...
{
    private const SDK_CLASS = 'BranchDailyExportsSDK';
    ...
    private const SDK_BASE = 'branchdailyexports_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../branchdailyexports_sdk.php';
