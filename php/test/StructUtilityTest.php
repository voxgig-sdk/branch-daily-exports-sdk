...
// BranchDailyExports SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BranchDailyExportsOmni::makeStructRunner(
    ...
    {
        return BranchDailyExportsOmni::objmodel(BranchDailyExportsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BranchDailyExportsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BranchDailyExportsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BranchDailyExportsOmni::structfix($now, Struct::undef()))
                        !== json_encode(BranchDailyExportsOmni::structfix($val, Struct::undef()))) {
