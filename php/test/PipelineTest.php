...
// BranchDailyExports SDK pipeline test
//
...
require_once __DIR__ . '/../branchdailyexports_sdk.php';
...
{
    private static function utility(): BranchDailyExportsUtility
    {
        return new BranchDailyExportsUtility();
    }
    ...
    private static function ctx(array $over = []): BranchDailyExportsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BranchDailyExportsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BranchDailyExportsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BranchDailyExportsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BranchDailyExportsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BranchDailyExportsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BranchDailyExportsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BranchDailyExportsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BranchDailyExportsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BranchDailyExportsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchDailyExportsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BranchDailyExportsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BranchDailyExportsResponse([]),
            'result' => new BranchDailyExportsResult([]),
        ]);
        [, $err] = BranchDailyExportsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BranchDailyExportsSpec([]),
            'response' => null,
            'result' => new BranchDailyExportsResult([]),
        ]);
        [, $err] = BranchDailyExportsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BranchDailyExportsSpec(['step' => 's']),
            'response' => new BranchDailyExportsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BranchDailyExportsResult([]),
        ]);
        [, $err] = BranchDailyExportsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchDailyExportsSpec(['step' => 's']),
            'response' => new BranchDailyExportsResponse(self::resp(200, ['v' => 1])),
            'result' => new BranchDailyExportsResult([]),
        ]);
        [, $err] = BranchDailyExportsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchDailyExportsSpec(['step' => 's']),
            'response' => new BranchDailyExportsResponse(self::resp(200, ['v' => 2])),
            'result' => new BranchDailyExportsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BranchDailyExportsMakeResponse::call($ctx);
    ...
    {
        $preset = new BranchDailyExportsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BranchDailyExportsSpec([]),
            'response' => new BranchDailyExportsResponse([]),
            'result' => new BranchDailyExportsResult([]),
        ...
        [$got, $err] = BranchDailyExportsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BranchDailyExportsResult([])]);
        [, $err] = BranchDailyExportsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BranchDailyExportsSpec([]), 'result' => null]);
        [, $err] = BranchDailyExportsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchDailyExportsSpec(['step' => 's']),
            'result' => new BranchDailyExportsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BranchDailyExportsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchDailyExportsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchDailyExportsSpec(['step' => 's']),
            'result' => new BranchDailyExportsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BranchDailyExportsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchDailyExportsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchDailyExportsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BranchDailyExportsSpec([]),
            'result' => new BranchDailyExportsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BranchDailyExportsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchDailyExportsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BranchDailyExportsError('boom', 'boom');
        $utility->fetcher = function (BranchDailyExportsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchDailyExportsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BranchDailyExportsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BranchDailyExportsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BranchDailyExportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BranchDailyExportsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BranchDailyExportsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BranchDailyExportsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchDailyExportsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BranchDailyExportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BranchDailyExportsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BranchDailyExportsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BranchDailyExportsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BranchDailyExportsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BranchDailyExportsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BranchDailyExportsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BranchDailyExportsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BranchDailyExportsResult(['ok' => false])]);
        $this->expectException(BranchDailyExportsError::class);
        BranchDailyExportsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BranchDailyExportsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BranchDailyExportsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BranchDailyExportsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BranchDailyExportsBaseFeature();
        $b = new BranchDailyExportsBaseFeature();
        BranchDailyExportsFeatureAdd::call($ctx, $a);
        BranchDailyExportsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BranchDailyExportsBaseFeature
    {
        $f = new BranchDailyExportsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BranchDailyExportsFeatureAdd::call($ctx, self::named_feature('a'));
        BranchDailyExportsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BranchDailyExportsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BranchDailyExportsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BranchDailyExportsFeatureAdd::call($ctx, $replace);
        ...
        BranchDailyExportsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BranchDailyExportsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BranchDailyExportsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchDailyExportsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BranchDailyExportsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BranchDailyExportsResponse(['headers' => null]),
            'result' => new BranchDailyExportsResult([]),
        ]);
        BranchDailyExportsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BranchDailyExportsResultBody::call($ctx);
