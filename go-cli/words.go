...
func registerSDKWords(r *eng.Registry, client *sdk.BranchDailyExportsSDK) {
...
func runOp(client *sdk.BranchDailyExportsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
