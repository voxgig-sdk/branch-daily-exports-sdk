# BranchDailyExports TypeScript SDK



The TypeScript SDK for the BranchDailyExports API — a type-safe, entity-oriented client with full async/await support.
...
```ts
// Create — returns the created Export ENTITY (.data() for the record)
...
├── src/
│   ├── BranchDailyExportsSDK.ts        # Main SDK class
